...
namespace XLua.LuaDLL
{
    ...
    public partial class Lua
	{
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaL_loadfile(IntPtr L, byte[] filename);

        public static byte[] GetUTF8Encode(string str)
        {
        ...
        public static int loadfile(IntPtr L, string filename)
        {
            byte[] nameBytes = GetUTF8Encode(filename);
            return luaL_loadfile(L, nameBytes);
        }

...
public class LightbeamEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            if (GLog.IsLogWarningEnabled) GLog.LogWarning("Escaped lightbeam modification mode. No valid lightbeam mesh was found.");
    ...
    public void OnSceneGUI()
    {
        ...
        if (lightBeam.IsModifyingMesh == true && IsLightBeamMesh() == false)
        {
            if (GLog.IsLogWarningEnabled) GLog.LogWarning("Exited lightbeam modification mode. No valid lightbeam mesh was found.");
            lightBeam.IsModifyingMesh = false;
        }

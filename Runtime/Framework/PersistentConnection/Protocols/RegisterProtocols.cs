namespace Capstones.Net
{
    public partial class ProtobufReaderAndWriter
    {
        ...
        private static RegisteredType _Reg_SetBattingModeOp = new RegisteredType(20, typeof(Protocols.SetBattingModeOp), Protocols.SetBattingModeOp.Parser);
        private static RegisteredType _Reg_SetBattingModeEvent = new RegisteredType(21, typeof(Protocols.SetBattingModeEvent), Protocols.SetBattingModeEvent.Parser);
        private static RegisteredType _Reg_MoveToNextStepOp = new RegisteredType(22, typeof(Protocols.MoveToNextStepOp), Protocols.MoveToNextStepOp.Parser);
        private static RegisteredType _Reg_MoveToNextStepResp = new RegisteredType(23, typeof(Protocols.MoveToNextStepResp), Protocols.MoveToNextStepResp.Parser);
        private static RegisteredType _Reg_PitchPrepareOp = new RegisteredType(24, typeof(Protocols.PitchPrepareOp), Protocols.PitchPrepareOp.Parser);
        private static RegisteredType _Reg_PitchReadyResp = new RegisteredType(25, typeof(Protocols.PitchReadyResp), Protocols.PitchReadyResp.Parser);
        private static RegisteredType _Reg_VainSwingOp = new RegisteredType(26, typeof(Protocols.VainSwingOp), Protocols.VainSwingOp.Parser);
        private static RegisteredType _Reg_VainSwingEvent = new RegisteredType(27, typeof(Protocols.VainSwingEvent), Protocols.VainSwingEvent.Parser);
        private static RegisteredType _Reg_PitcherUrgeEvent = new RegisteredType(28, typeof(Protocols.PitcherUrgeEvent), Protocols.PitcherUrgeEvent.Parser);
        private static RegisteredType _Reg_BeginBatSwingOp = new RegisteredType(29, typeof(Protocols.BeginBatSwingOp), Protocols.BeginBatSwingOp.Parser);
        private static RegisteredType _Reg_BeginBatSwingEvent = new RegisteredType(30, typeof(Protocols.BeginBatSwingEvent), Protocols.BeginBatSwingEvent.Parser);

...
namespace XLuaExt
{
    public static class LuaEvent
    {
        ...
        public static int RegJavaHandler(string cate, IntPtr runnable)
        {
            if (cate == "Call!")
            {
                using (var real = new JavaEventHandler() { _Runnable = runnable })
                {
                    real.Call(cate);
                }
                return 0;
        ...
        public static void Init(IntPtr L)
        {
            ...
            LuaAPI.xlua_setglobal(L, "luaevt");
            LuaAPI.xlua_pushasciistring(L, "trig");
            LuaAPI.lua_pushstdcallcfunction(L, TrigLuaEvent);
            LuaAPI.xlua_psettable(L, -3);
            LuaAPI.xlua_pushasciistring(L, "reg");
            LuaAPI.lua_pushstdcallcfunction(L, RegLuaEventHandler);
            LuaAPI.xlua_psettable(L, -3);
            LuaAPI.xlua_pushasciistring(L, "unreg");
            LuaAPI.lua_pushstdcallcfunction(L, UnregLuaEventHandler);
            LuaAPI.xlua_psettable(L, -3);
            LuaAPI.xlua_pushasciistring(L, "reset");
            LuaAPI.lua_pushstdcallcfunction(L, ResetLuaEventReg);
            LuaAPI.xlua_psettable(L, -3);
            LuaAPI.xlua_pushasciistring(L, "delayed");
            LuaAPI.lua_pushstdcallcfunction(L, LuaDelayedEvents);
            LuaAPI.xlua_psettable(L, -3);
        ...
        internal static readonly lua.CFunction Func_TrigLuaEvent = TrigLuaEvent;
        internal static readonly lua.CFunction Func_HandleNativeEvent = HandleNativeEvent;
